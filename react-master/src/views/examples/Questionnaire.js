...
const QuestionsForm = () => {
  ...
  const questions = [
    ...
    {
      question:
        "How does the software feature contribute to economic growth within its operating environment?",
      subQuestions: [
    ...
    {
      question:
        "How does the software feature ensure cost-effectiveness for users?",
      subQuestions: [
    ...
    {
      question:
        "How is the software feature designed to be maintainable and supportable long-term?",
      subQuestions: [
    ...
    {
      question:
        "How is the software feature prepared to handle data evolution, such as changes in data volume, variety, and velocity?",
      subQuestions: [
    ...
    {
      question:
        "How does the software feature ensure ethical use of data and protect user privacy?",
      subQuestions: [
    ...
    {
      question:
        "How does the software feature address the needs of global and multicultural users?",
      subQuestions: [
    ...
    {
      question:
        "In what ways does the software feature enable users to manage their mental and physical health?",
      subQuestions: [
    ...
    {
      question:
        "In what ways does the software feature enhance individual creativity and self-expression?",
      subQuestions: [
